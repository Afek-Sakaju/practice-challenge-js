...
game_with_number() that takes an array (arr), 
sizeOfArray (n), and return the array re-constructed 
array arr. The driver code takes care of the printing.
...
module.exports.game_with_number = function (arr) {

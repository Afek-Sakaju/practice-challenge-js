...
on the same day. Arrival and departure time can never be the same 
for a train but we can have arrival time of one train equal to 
departure time of the other. At any given instance of time, 
...
const arr1 = [0900, 0940, 0950, 1100, 1500, 1800];
const arr2 = [0910, 1200, 1120, 1130, 1900, 2000];

const arr3 = [0900, 1100, 1235];
const arr4 = [1000, 1200, 1240];

console.log(findPlatform(arr3, arr4));
